...
const AddInventoryModal = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedCurrentStock =
      (existingItem?.CurrentStock || 0) + newItem.quantity;
        ...
        <div className="bg-white rounded-2xl w-[550px] max-h-[90vh] overflow-y-auto shadow-2xl">
          <div className="bg-green-500 px-3 py-4">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl px-38 font-bold text-white">
                Add New Inventory
              </h2>
            </div>
          </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewItem({
                      ...newItem,
                      Stocks: e.target.value as InventoryItem["Stocks"],
                    })
                  }
                  required
                >
    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="bg-white rounded-2xl w-[550px] max-h-[90vh] overflow-y-auto shadow-2xl">
          <div className="bg-green-500 px-3 py-4">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl px-40 font-bold text-white">
                Edit Inventory
              </h2>
            </div>
          </div>
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <select
            ...
            value={stockFilter}
            onChange={(e) =>
              setStockFilter(e.target.value as "all" | InventoryItem["Stocks"])
            }
          >
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border rounded-lg">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-6 py-3.5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tl-lg">
                ID
              </th>
              ...
              <th className="px-6 py-3.5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider rounded-tr-lg">
                Actions
              </th>
            </tr>
          </thead>
