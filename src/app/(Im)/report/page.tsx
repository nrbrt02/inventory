...
export default function ReportPage() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4"> {/* Changed to 3 columns */}
    ...
    <div className="flex items-end"> {/* Added container to align button properly */}
      <button
        onClick={downloadPDF}
        className="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors w-full"
      >
